...
const OPENAI_API_KEY = "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"; 
...
const generateAiImages = async (userPrompt, userImgQuantity) => {
  try {
    ...
    if(!response.ok) throw new Error("Failed to generate AI images. Check your connection.");
